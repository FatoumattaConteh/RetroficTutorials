...
public class post_method_example extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_get_post_method_example);
    ...
    private void do_upload() {
        ...
        //step 3
        Call<String> plain_text_call=webInterface.post_method_example(name,country,age);
